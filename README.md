...
With `Query`, you can **filter data dynamically**
...
* **Integration with Spring Data**: Seamlessly use `Specification`.
...
2. **Use** `Query` on your repository/service code to build dynamic queries.
...
> internals. The library’s main public classes are `Query`, `SearchOperator`, `ProjectionFactory`, and `Projection`.
