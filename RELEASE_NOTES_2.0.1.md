...
- Spring Data JPA `3.4.2` -> `3.4.13`
- Spring Test `6.2.2` -> `6.2.19`
- Lombok `1.18.34` -> `1.18.46`
- Jackson Databind `2.18.0` -> `2.18.8`
- Hibernate Core (test scope) `6.2.7.Final` -> `6.6.53.Final`
- H2 (test scope) `2.3.232` -> `2.4.240`
